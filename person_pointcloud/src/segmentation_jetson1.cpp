...
void
cloud_cb (const sensor_msgs::PointCloud2ConstPtr& cloud_J1)
{
  ...
  pcl_conversions::toPCL(*cloud_J1, *cloud);
...
{
  // Initialize ROS
    ros::init (argc, argv, "segmentation_jetson1");

    ros::NodeHandle nh;


  // Create ROS subscriber for the input point cloud
  ros::Subscriber sub = nh.subscribe ("/crop_box/jetson1", 1, cloud_cb);

  // Create a ROS publisher for the output point cloud
  pub = nh.advertise<sensor_msgs::PointCloud2> ("person_points/jetson1", 1);
